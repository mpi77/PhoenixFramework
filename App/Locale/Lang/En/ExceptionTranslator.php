...
class ExceptionTranslator implements IModuleTranslator {
    ...
    private static $data = array (
                    ...
                    ED::F_CLASS_NOT_FOUND => "Missing required class.",
                    ED::F_DB_MISSING_CONFIG => "Empty config data for connect to db.",
                    ED::F_DB_UNABLE_CONNECT => "Unnable to connect to db server.",
                    ED::F_DB_UNABLE_SET_CHARSET => "Unable to set db charset.",
                    ...
                    ED::F_REQUEST_INVALID_METHOD => "Unable to create request, method is invalid.",
